    ...
    <div class="container-fluid">
        <div class="main-content d-flex flex-column px-0">
            <div class="m-auto mw-510 py-5">
                <form action="{{url('/')}}/admin/recover" method="post">
                    @csrf
                    ...
                    <div class="card bg-white border-0 rounded-10 mb-4">
                        <div class="card-body p-4">
                            <div class="form-group mb-4">
                                <label class="label">نام کاربری یا شماره موبایل </label>
                                <input type="text" name="user" class="form-control h-58" placeholder="نام کاربری یا شماره موبایل">
                            </div>

                        </div>
                    </div>

                    <button type="submit" class="btn btn-primary fs-16 fw-semibold text-dark heading-fornt py-2 py-md-3 px-4 text-white w-100"> بازیابی اطلاعات </button>
                </form>
            </div>
        </div>
    </div>
