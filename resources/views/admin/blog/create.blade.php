...
<div class="container mt-5 mb-5">
    ...
    <div class="card shadow-lg border-0">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0">افزودن مقاله جدید</h5>
            ...
            <form action="{{ url('/admin/blog/store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="category" class="form-control" value="{{ old('category') }}" placeholder="مثال: اخبار، نکات، تحلیل بازار">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label">برچسب‌ها (با کاما جدا کنید)</label>
                        <input type="text" name="tags" class="form-control" value="{{ old('tags') }}" placeholder="مثال: مسکن، سرمایه‌گذاری، تهران">
                    </div>
                ...
                <button type="submit" class="btn btn-success w-100 py-2 mt-3">ذخیره مقاله</button>
            </form>
        </div>
    </div>
</div>
...
<script>
    document.getElementById('image-input').addEventListener('change', function (event) {
        ...
        if (file) {
            ...
            preview.src = "";
            fileName.textContent = "انتخاب تصویر";
        }
    });
