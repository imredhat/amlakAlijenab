											...
											<div class="notification-menu">
												<a href="notification.html" class="dropdown-item p-0">
													...
													<div class="d-flex align-items-center">
														<div class="flex-shrink-0"> <img src="{{ url ('/') }}/assets/images/pdf.svg" alt="pdf"> </div>
														<div class="flex-grow-1 ms-3">
															<p>فاکتورها به شرکت پرداخت شده است.</p>
														</div>
													</div> <span>ساعت 23:47 چهارشنبه</span> </a>
											</div>
											<div class="notification-menu mb-0">
												<a href="notification.html" class="dropdown-item p-0">
													<h4>ایجاد یک پروژه جدید</h4>
													<div class="d-flex align-items-center">
														<div class="flex-shrink-0"> <img src="{{ url ('/') }}/assets/images/notifications-1.jpg" alt="notifications"> </div>
														<div class="flex-grow-1 ms-3">
															<p>به کاربران اجازه دهید محصولات موجود در ووکامرس شما را دنبال کنند</p>
														</div>
													</div> <span>21 دی 1402</span> </a>
								...
								<li class="header-right-item">
									<div class="dropdown admin-profile">
										<div class="d-xxl-flex align-items-center bg-transparent border-0 text-start p-0 cursor" data-bs-toggle="dropdown">
											<div class="flex-shrink-0"> <img class="rounded-circle wh-54" src="{{ url ('/') }}/assets/images/admin.jpg" alt="admin"> </div>
											<div class="flex-grow-1 ms-3">
												<div class="d-flex align-items-center justify-content-between">
													<div class="d-none d-xxl-block"> <span class="degeneration">مدیر</span>
														<div class="d-flex align-content-center">
															<h3>{{ $admin -> name .' '.$admin -> lname }}</h3>
															<div class="down"> <i data-feather="chevron-down"></i> </div>
														</div>
													</div>
												</div>
											</div>
										...
										<ul class="dropdown-menu border-0 bg-white w-100 admin-link">
											<li>
												<a class="dropdown-item d-flex align-items-center text-body" href="profile.html"> <i data-feather="user"></i> <span class="ms-2">پروفایل</span> </a>
											</li>
											<li>
												<a class="dropdown-item d-flex align-items-center text-body" href="account.html"> <i data-feather="settings"></i> <span class="ms-2">تنظیمات</span> </a>
											</li>
											<li>
												<a class="dropdown-item d-flex align-items-center text-body" href="{{ url('/admin/logout') }}"> <i data-feather="log-out"></i> <span class="ms-2">خروج</span> </a>
											</li>
										</ul>
									</div>
								</li>
