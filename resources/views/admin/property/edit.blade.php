...
<div class="container mt-5 mb-md-4 py-5">
    <div class="row">
        <div class="col-lg-12 add-property">
            ...
            <form enctype="multipart/form-data" action="{{ url('/admin/property/update/' . $property_id) }}" method="post">
                @csrf
                @method('PUT')

                <section class="card card-body border-0 shadow-sm p-4 mb-4" id="basic-info">
                    <h2 class="h5 mb-4"><i class="fi-info-circle text-primary fs-5 mt-n1 me-2"></i>ویرایش آگهی : {{ $property -> title }}</h2>
