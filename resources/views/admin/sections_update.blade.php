            ...
            <form action="{{ route('sections.update', $section->_id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="position" class="form-control" required value="{{ $section -> position }}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label">عنوان</label>
                        <input type="text" name="title" class="form-control" required value="{{ $section -> title }}">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="file" name="pic" class="form-control" id="pic-input" value="{{ $section -> pic }}">
                    </div>

                    <div class="col-md-4 mt-2">
                        <img id="preview-image" class="image-preview" alt="Preview" src="{{url('/')}}{{ $section -> pic }}">
                    </div>
