        ...
        <div class="card card-body" style="max-width: 940px"><a class="position-absolute top-0 end-0 nav-link fs-sm py-1 px-2 mt-3 me-3" href="signin-light.html#" onclick="window.history.go(-1); return false;"><i class="fi-arrow-long-right fs-base me-2"></i>برگشت</a>
              <div class="row mx-0 align-items-center">
                ...
                <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                  ...
                  <form class="needs-validation" novalidate action="{{ url('/auth/signUp') }}" method="post" autocomplete="on">
                    @csrf
                    <div class="mb-4">
                    ...
                    document.querySelector('.form-control:last-child').addEventListener('input', (e) => {
                      if (e.target.value) {
                    ...
                    <button class="btn btn-primary btn-lg w-100" type="submit">ثبت</button>
                  </form>
                </div>
              </div>
