 ...
 <div class="col">
     <div class="card shadow-sm card-hover border-0 h-100">
         ...
         <div><i class="fi-cash mt-n1 me-2 lead align-middle opacity-70"></i>{{number_format(($p -> regular_days ?? 0))}} تومان</div>
         <div><i class="fi-rent mt-n1 me-2 lead align-middle opacity-70"></i>{{number_format(($p -> weekend ?? 0))}} تومان</div>
         </div>
