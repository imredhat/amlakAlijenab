...
<div class="row">
    ...
    <div class="col-sm-12 pb-3 pe-3 pt-3 ps-3">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="pets-friendly" name="amenities[]" value="نگهداری حیوانات خانگی" {{ (is_array($amenities) && in_array('نگهداری حیوانات خانگی', $amenities)) ? 'checked' : '' }}>
                    <label class="form-check-label" for="pets-friendly">نگهداری حیوانات خانگی</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="pool" name="amenities[]" value="استخر" {{ (is_array($amenities) && in_array('استخر', $amenities)) ? 'checked' : '' }}>
                    <label class="form-check-label" for="pool">استخر</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="metro" name="amenities[]" value="دسترسی به مترو" {{ (is_array($amenities) && in_array('دسترسی به مترو', $amenities)) ? 'checked' : '' }}>
                    <label class="form-check-label" for="metro">دسترسی به مترو</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="tv" name="amenities[]" value="تلویزیون" {{ (is_array($amenities) && in_array('تلویزیون', $amenities)) ? 'checked' : '' }}>
                    <label class="form-check-label" for="tv">تلویزیون</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="terrace" name="amenities[]" value="تراس" {{ (is_array($amenities) && in_array('تراس', $amenities)) ? 'checked' : '' }}>
                    <label class="form-check-label" for="terrace">تراس</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="heating" name="amenities[]" value="سیستم گرمایشی" {{ (is_array($amenities) && in_array('سیستم گرمایشی', $amenities)) ? 'checked' : '' }}>
                    <label class="form-check-label" for="heating">سیستم گرمایشی</label>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="washer" name="amenities[]" value="ماشین لباسشویی" {{ (is_array($amenities) && in_array('ماشین لباسشویی', $amenities)) ? 'checked' : '' }}>
                    <label class="form-check-label" for="washer">ماشین لباسشویی</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="stove" name="amenities[]" value="گاز رومیزی" {{ (is_array($amenities) && in_array('گاز رومیزی', $amenities)) ? 'checked' : '' }}>
                    <label class="form-check-label" for="stove">گاز رومیزی</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="elevator" name="amenities[]" value="آسانسور" {{ (is_array($amenities) && in_array('آسانسور', $amenities)) ? 'checked' : '' }}>
                    <label class="form-check-label" for="elevator">آسانسور</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="kitchen" name="amenities[]" value="آشپزخانه" {{ (is_array($amenities) && in_array('آشپزخانه', $amenities)) ? 'checked' : '' }}>
                    <label class="form-check-label" for="kitchen">آشپزخانه</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="breakfast" name="amenities[]" value="صبحانه" {{ (is_array($amenities) && in_array('صبحانه', $amenities)) ? 'checked' : '' }}>
                    <label class="form-check-label" for="breakfast">صبحانه</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="security-cameras" name="amenities[]" value="دوربین مداربسته" {{ (is_array($amenities) && in_array('دوربین مداربسته', $amenities)) ? 'checked' : '' }}>
