...
<div class="row">
    ...
    <div class="col-sm-6 pb-3 pe-3 pt-3 ps-3">
        <label for="pool">
            <input type="checkbox" name="pool" id="pool" class="form-check-input" value="1" {{ (old('pool', $property->pool ?? '') == '1') ? 'checked' : '' }}>
            استخر
        </label>
    </div>
    ...
    <div class="col-sm-6 pb-3 pe-3 pt-3 ps-3">
        <label for="sauna">
            <input type="checkbox" name="sauna" id="sauna" class="form-check-input" value="1" {{ (old('sauna', $property->sauna ?? '') == '1') ? 'checked' : '' }}>
            سونا
        </label>
    </div>
    ...
    <div class="col-sm-6 pb-3 pe-3 pt-3 ps-3">
        <label for="jacuzzi">
            <input type="checkbox" name="jacuzzi" id="jacuzzi" class="form-check-input" value="1" {{ (old('jacuzzi', $property->jacuzzi ?? '') == '1') ? 'checked' : '' }}>
            جکوزی
        </label>
    </div>
    ...
    <div class="col-sm-6 pb-3 pe-3 pt-3 ps-3">
        <label for="furnished">
            <input type="checkbox" name="furnished" id="furnished" class="form-check-input" value="1" {{ (old('furnished', $property->furnished ?? '') == '1') ? 'checked' : '' }}>
            مبله
        </label>
    </div>
