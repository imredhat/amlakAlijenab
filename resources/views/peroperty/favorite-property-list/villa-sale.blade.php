...
<div class="card card-hover card-horizontal border-0 shadow-sm mb-4">
    ...
    <div class="card-body position-relative pb-3">
        <div class="position-absolute zindex-5 top-0 end-0 mt-3 me-3">
            <button class="btn btn-icon btn-light btn-xs text-primary rounded-circle shadow-sm favorite-btn is-favorited" type="button" data-bs-toggle="tooltip" title="حذف از علاقه مندی" data-property-id="{{ $p->id }}"><i class="fi-heart"></i></button>
        </div>
        ...
        <div class="d-flex align-items-center justify-content-center justify-content-sm-start border-top pt-3 pb-2 mt-3 text-nowrap">
            ...
            <span class="d-inline-block fs-sm">{{$p->floor_count}}<i class="fi-layers ms-1 mt-n1 fs-lg text-muted"></i></span>
        </div>
    </div>
</div>
