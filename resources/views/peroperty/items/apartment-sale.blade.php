        ...
        <div class="col-lg-7">
            ...
            <div class="mb-sm-3 mt-4">
                ...
                <ul class="list-unstyled row row-cols-lg-3 row-cols-md-2 row-cols-1 gy-1 mb-1 text-nowrap">
                    ...
                    <?php if (isset($property[0]->pool) && $property[0]->pool === 'on'): ?><li class="col"><i class="fi-swimming-pool mt-n1 me-2 fs-lg align-middle"></i>استخر</li><?php endif; ?>
                    <?php if (isset($property[0]->sauna) && $property[0]->sauna === 'on'): ?><li class="col"><i class="fi-spa mt-n1 me-2 fs-lg align-middle"></i>سونا</li><?php endif; ?>
                    <?php if (isset($property[0]->jacuzzi) && $property[0]->jacuzzi === 'on'): ?><li class="col"><i class="fi-bath mt-n1 me-2 fs-lg align-middle"></i>جکوزی</li><?php endif; ?>
                    <?php if (isset($property[0]->furnished) && $property[0]->furnished === 'on'): ?><li class="col"><i class="fi-align-justify mt-n1 me-2 fs-lg align-middle"></i>مبله</li><?php endif; ?>
                    <?php if (isset($property[0]->convertible) && $property[0]->convertible === 'on'): ?><li class="col"><i class="fi-refresh mt-n1 me-2 fs-lg align-middle"></i>قابل تبدیل</li><?php endif; ?>
                    <?php if (isset($property[0]->rebuilt) && $property[0]->rebuilt === '1'): ?><li class="col"><i class="fi-home mt-n1 me-2 fs-lg align-middle"></i>بازسازی شده</li><?php endif; ?>
                </ul>
                
                <div class="collapse" id="seeMoreAmenities">
                    <ul class="list-unstyled row row-cols-lg-3 row-cols-md-2 row-cols-1 gy-1 mb-1 text-nowrap">
                        <?php if (isset($property[0]->cooling_system) && !empty($property[0]->cooling_system)): ?><li class="col"><i class="fi-snowflake mt-n1 me-2 fs-lg align-middle"></i>سیستم سرمایش: <?php echo $property[0]->cooling_system; ?></li><?php endif; ?>
                        <?php if (isset($property[0]->heating_system) && !empty($property[0]->heating_system)): ?><li class="col"><i class="fi-thermometer mt-n1 me-2 fs-lg align-middle"></i>سیستم گرمایش: <?php echo $property[0]->heating_system; ?></li><?php endif; ?>
                        ...
                        <ul class="list-unstyled mt-n2 mb-0">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><td>نوع ملک</td><td><b>{{$property[0]->property_type ?? ''}}</b></td></tr>
                                    <tr><td>نوع</td><td><b>{{getCat($property[0]->category)}}</b></td></tr>
                                    <tr><td>متراژ (مترمربع)</td><td><b>{{number_format($property[0]->area)}}</b></td></tr>
                                    ...
                                    <?php if(isset($property[0]->floor_type) && !empty($property[0]->floor_type)): ?><tr><td>نوع کف</td><td><b>{{$property[0]->floor_type}}</b></td></tr><?php endif; ?>
                                    <?php if(isset($property[0]->building_facade) && !empty($property[0]->building_facade)): ?><tr><td>نما</td><td><b>{{$property[0]->building_facade}}</b></td></tr><?php endif; ?>
                                    <?php if(isset($property[0]->rebuilt) && $property[0]->rebuilt === '1'): ?><tr><td>بازسازی</td><td><b>دارد</b></td></tr><?php endif; ?>
