    ...
    <div class="row gy-5 pt-lg-2">
        <div class="col-lg-7">
            ...
            <div class="mb-sm-3 mt-4">
                ...
                <ul class="list-unstyled row row-cols-lg-3 row-cols-md-2 row-cols-1 gy-1 mb-1 text-nowrap">
                    ...
                    <?php if (isset($property[0]->toilet) && $property[0]->toilet === 'دارد'): ?><li class="col"><i class="fi-bath mt-n1 me-2 fs-lg align-middle"></i>سرویس بهداشتی</li><?php endif; ?>
                    <?php if (isset($property[0]->convertible) && $property[0]->convertible === '1'): ?><li class="col"><i class="fi-refresh mt-n1 me-2 fs-lg align-middle"></i>قابل تبدیل</li><?php endif; ?>
                    ...
                    <?php if (isset($property[0]->utilities) && is_array($property[0]->utilities)): ?>
                        ...
                        <?php if (in_array('تلفن', $property[0]->utilities)): ?><li class="col"><i class="fi-phone mt-n1 me-2 fs-lg align-middle"></i>تلفن</li><?php endif; ?>
                            <?php if (isset($property[0]->type) && !empty($property[0]->type)): ?><li class="col"><i class="fi-briefcase mt-n1 me-2 fs-lg align-middle"></i>نوع: <?php echo $property[0]->type; ?></li><?php endif; ?>
                            <?php if (isset($property[0]->usage_type) && !empty($property[0]->usage_type)): ?><li class="col"><i class="fi-settings mt-n1 me-2 fs-lg align-middle"></i>نوع کاربری: <?php echo $property[0]->usage_type; ?></li><?php endif; ?>
                    <?php endif; ?>
                </ul>
        ...
        <aside class="col-lg-5">
            <div class="ps-lg-5">
                ...
                <!-- نمایش قیمت برای commercial-rent -->
                <h3 class="h5 mb-2">قیمت:</h3>
                <div class="mb-4 pb-2">
                    <?php if (isset($property[0]->mortgage) && $property[0]->mortgage > 0): ?>
                    ...
                    <?php if (isset($property[0]->rent) && $property[0]->rent > 0): ?>
                        ...
                        <ul class="list-unstyled mt-n2 mb-0">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><td>نوع</td><td><b>{{$property[0]->type ?? ''}}</b></td></tr>
                                    ...
                                    <?php if(isset($property[0]->toilet) && $property[0]->toilet === 'دارد'): ?><tr><td>سرویس بهداشتی</td><td><b>دارد</b></td></tr><?php endif; ?>
                                    <?php if(isset($property[0]->convertible) && $property[0]->convertible === '1'): ?><tr><td>قابل تبدیل</td><td><b>دارد</b></td></tr><?php endif; ?>
                                    
                                    <!-- امکانات عمومی -->
                                    <?php if(isset($property[0]->utilities) && is_array($property[0]->utilities)): ?>
                                        <tr><td>امکانات</td><td><b><?php echo implode('، ', $property[0]->utilities); ?></b></td></tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        </ul>
