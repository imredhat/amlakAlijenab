    ...
    <div class="row gy-5 pt-lg-2">
        <div class="col-lg-7">
            ...
            <div class="mb-sm-3 mt-4">
                <h3 class="h5 mb-3">امکانات تجاری</h3>
                ...
                <div class="collapse" id="seeMoreAmenities">
                    <ul class="list-unstyled row row-cols-lg-3 row-cols-md-2 row-cols-1 gy-1 mb-1 text-nowrap">
                        <!-- سایر امکانات -->
                        <?php if (isset($property[0]->utilities) && is_array($property[0]->utilities)): ?>
                            <?php if (in_array('اتاق مدیریت', $property[0]->utilities)): ?><li class="col"><i class="fi-user-check mt-n1 me-2 fs-lg align-middle"></i>اتاق مدیریت</li><?php endif; ?>
                            <?php if (in_array('اتاق کنفرانس', $property[0]->utilities)): ?><li class="col"><i class="fi-users mt-n1 me-2 fs-lg align-middle"></i>اتاق کنفرانس</li><?php endif; ?>
                            <?php if (in_array('فضای پذیرش/منشی', $property[0]->utilities)): ?><li class="col"><i class="fi-user mt-n1 me-2 fs-lg align-middle"></i>فضای پذیرش</li><?php endif; ?>
                            <?php if (in_array('آبدارخانه/آشپزخانه کوچک', $property[0]->utilities)): ?><li class="col"><i class="fi-coffee mt-n1 me-2 fs-lg align-middle"></i>آبدارخانه</li><?php endif; ?>
                            <?php if (in_array('تابلوخور', $property[0]->utilities)): ?><li class="col"><i class="fi-award mt-n1 me-2 fs-lg align-middle"></i>تابلوخور</li><?php endif; ?>
                            <?php if (in_array('ورودی مجزا', $property[0]->utilities)): ?><li class="col"><i class="fi-door mt-n1 me-2 fs-lg align-middle"></i>ورودی مجزا</li><?php endif; ?>
                            <?php if (in_array('نگهبانی/لابی من', $property[0]->utilities)): ?><li class="col"><i class="fi-shield mt-n1 me-2 fs-lg align-middle"></i>نگهبانی</li><?php endif; ?>
                        <?php endif; ?>
        ...
        <aside class="col-lg-5">
            <div class="ps-lg-5">
                ...
                <div class="card border-0 bg-secondary mb-4">
                    <div class="card-body">
                        <h5 class="mb-0 pb-3">مشخصات تجاری</h5>
                        <ul class="list-unstyled mt-n2 mb-0">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><td>سال ساخت</td><td><b>{{$property[0]->year_built ?? ''}}</b></td></tr>
                                    <tr><td>طبقه</td><td><b>{{$property[0]->floor ?? ''}}</b></td></tr>
                                    <tr><td>تعداد اتاق</td><td><b>{{$property[0]->rooms ?? ''}}</b></td></tr>
                                    <tr><td>نوع ملک</td><td><b><?php echo $property[0]->type === 'industrial' ? 'صنعتی' : ($property[0]->type ?? ''); ?></b></td></tr>
                                    <tr><td>نوع کاربری</td><td><b>{{$property[0]->usage_type ?? ''}}</b></td></tr>
                                    <tr><td>وضعیت سند</td><td><b><?php echo getDocStatus($property[0]->document_status ?? ''); ?></b></td></tr>
                                    <tr><td>وضعیت فعلی</td><td><b><?php echo getCurrentStatus($property[0]->current_status ?? ''); ?></b></td></tr>
                                    ...
                                    <!-- امکانات عمومی -->
                                    <?php if(isset($property[0]->utilities) && is_array($property[0]->utilities)): ?>
                                        <tr><td colspan="2"><b>امکانات:</b></td></tr>
                                        <tr>
                                            <td colspan="2">
                                        <?php 
                                        $chunkedUtilities = array_chunk($property[0]->utilities, 2);
                                        foreach ($chunkedUtilities as $chunk): 
                                        ?>
                                                    <?php foreach ($chunk as $utility): ?>
