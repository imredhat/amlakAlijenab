<!-- views/property/items/similar/land_similar.blade.php -->
...
<div class="card-footer d-flex align-items-center justify-content-center mx-3 pt-3 text-nowrap">
    ...
    <!-- نوع کاربری -->
    <span class="d-inline-block me-4 fs-sm">
        <?= $s->usage_type ?? '' ?><i class="fi-layers ms-1 mt-n1 fs-lg text-muted"></i>
    </span>

    <!-- موقعیت -->
    <span class="d-inline-block fs-sm">
        <?= $s->property_location ?? '' ?><i class="fi-map-pin ms-1 mt-n1 fs-lg text-muted"></i>
    </span>
</div>