    ...
    <div class="card shadow-sm card-hover border-0 h-100">
        <div class="tns-carousel-wrapper card-img-top card-img-hover">
            ...
            <div class="content-overlay end-0 top-0 pt-3 pe-3">
                <button class="btn btn-icon btn-light btn-xs text-primary rounded-circle favorite-btn" type="button" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="نشان کردن" data-bs-original-title="نشان کردن" data-property-id="{{ $p->id }}">
                    <i class="fi-heart"></i>
                </button>
            </div>
        ...
        <div class="card-footer d-flex align-items-center justify-content-center mx-3 pt-3 text-nowrap">
            <span class="d-inline-block mx-1 px-2 fs-sm">{{$p->roomCount}}<i class="fi-bed ms-1 mt-n1 fs-lg text-muted"></i></span>
            <span class="d-inline-block mx-1 px-2 fs-sm">{{$p->area}}<i class="fi-home ms-1 mt-n1 fs-lg text-muted"></i></span>
            <span class="d-inline-block mx-1 px-2 fs-sm">{{$p->totalFloors}}<i class="fi-layers ms-1 mt-n1 fs-lg text-muted"></i></span>
        </div>
    </div>
</div>