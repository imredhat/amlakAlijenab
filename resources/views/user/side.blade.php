...
<aside class="col-lg-4 col-md-5 pe-xl-4 mb-5">
    ...
    <div class="card card-body border-0 shadow-sm pb-1 me-lg-1">
        <div class="d-flex d-md-block d-lg-flex align-items-start pt-lg-2 mb-4">
            ...
            <img class="rounded-circle" src="{{url('')}}/upload/user/{{ $user[0] -> id }}/{{ $user[0] -> avatar }}" style="height: 50px;" width="48" alt="{{ $user[0] -> name .' '.$user[0] -> lname.' '.$user[0] -> bio }}">
        ...
        <div class="collapse d-md-block mt-3" id="account-nav">
            <div class="card-nav">
                ...
                <a class="card-nav-link" href="{{url('/')}}/user/nardban"><i class="fi-flame opacity-60 me-2"></i>نردبان</a>
